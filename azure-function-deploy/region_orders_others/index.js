                ...
                if (!decision.generate) {
                    ...
                    if (BULK) {
                        ...
                        try {
                            ...
                            context.log.error(`[W${id}] structures.json enrichment failed for ${regionId}: ${e.message}`);
                            telemetry.trackException(e, { area: 'region_orders_others', step: 'structures_enrich', regionId: String(regionId) });
                        }
                    }
                    success++;
                }
