...
// Usage: node scripts/seed-region-hauling-static.js <FROM_REGION> <TO_REGION> [limit]
...
async function main() {
    ...
    if (!from || !to) {
        console.error('Usage: node scripts/seed-region-hauling-static.js <FROM_REGION> <TO_REGION> [limit]');
        process.exit(1);
    }
